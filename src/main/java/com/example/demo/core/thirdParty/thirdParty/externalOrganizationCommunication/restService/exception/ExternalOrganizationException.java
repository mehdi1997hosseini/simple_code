package com.example.demo.core.thirdParty.thirdParty.externalOrganizationCommunication.restService.exception;


import ir.smarttrustco.pssnote.core.exceptionHandler.BasicSpecificationException;
...
public enum ExternalOrganizationException implements BasicSpecificationException {
    ...
    EXTERNAL_ORGANIZATION_SERVER_ERROR("external.organization.server.error", "403"),
