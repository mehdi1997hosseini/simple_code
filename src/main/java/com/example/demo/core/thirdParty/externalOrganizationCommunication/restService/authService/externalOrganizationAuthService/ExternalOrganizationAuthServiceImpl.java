...
import com.example.demo.core.thirdParty.externalOrganizationCommunication.restService.authService.externalOrganizationAuthService.mapper.ExternalOrganizationAuthMapper;
import com.example.demo.core.thirdParty.externalOrganizationCommunication.restService.authService.requestAuthConfig.RequestAuthConfigService;
import com.example.demo.core.thirdParty.externalOrganizationCommunication.restService.authService.requestTemplateAuthConfig.RequestTemplateAuthConfigService;
import com.example.demo.core.thirdParty.externalOrganizationCommunication.restService.authService.responseTokenConfig.ResponseTokenConfigService;
...
import com.example.demo.core.thirdParty.externalOrganizationCommunication.restService.exception.ExternalOrganizationException;
...
public class ExternalOrganizationAuthServiceImpl extends BasicServiceImpl<ExternalOrganizationAuthServiceEntity, String, ExternalOrganizationAuthServiceRepository> implements ExternalOrganizationAuthService {
    ...
    public void refreshManuallyExternalOrganization(String organizationName) {
        ...
        ExternalOrganizationAuthServiceEntity externalOrganizationByOrgName = findExternalOrganizationByOrgName(orgName).stream()
                .filter(entity -> entity.getIsDeleted().equals(Boolean.FALSE)).findFirst().orElse(null);
